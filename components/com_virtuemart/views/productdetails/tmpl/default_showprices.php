...
<div class="product-price" id="productPrice<?php echo $this->product->virtuemart_product_id ?>">
    ...
    echo $this->currency->createPriceDiv('salesPrice', 'TM_VIRTUEMART_PRODUCT_SALESPRICE', $this->product->prices);
	echo $this->currency->createPriceDiv('priceWithoutTax', 'TM_VIRTUEMART_PRODUCT_SALESPRICE_WITHOUT_TAX', $this->product->prices);
