...
<div class="manufacturer">
	...
	?>
        <span class="bold"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DETAILS_MANUFACTURER_LBL') ?></span><a class="modal" rel="{handler: 'iframe', size: {x: 350, y: 200}}" href="<?php echo $link ?>"><?php echo $text ?></a>
    <?php } ?>
</div>