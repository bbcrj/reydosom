 ...
 * @version $Id: select_payment.php 5334 2012-01-29 02:32:29Z electrocity $
 */
...
if (VmConfig::get('oncheckout_show_steps', 1)) {
    echo '<h1 class="checkoutStep" id="checkoutStep3">' . JText::_('COM_VIRTUEMART_USER_FORM_CART_STEP3') . '</h1>';
}
?>
...
<?php
echo "<p>".JText::_('COM_VIRTUEMART_CART_SELECT_PAYMENT')."</p>";
