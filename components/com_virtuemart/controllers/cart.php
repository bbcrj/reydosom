 ...
 * @version $Id: cart.php 5039 2011-12-12 19:23:59Z electrocity $
 */
...
//			}
	...
	if ($data->totalProduct > 1)
	    $data->totalProductTxt = JText::sprintf('TM_VIRTUEMART_CART_X_PRODUCTS', $data->totalProduct);
	else if ($data->totalProduct == 1)
	    $data->totalProductTxt = JText::_('TM_VIRTUEMART_ITEM');
	else
	    $data->totalProductTxt = JText::_('TM_VIRTUEMART_EMPTY_CART');
