...
/**
*
* @version $Id: minixml.inc.php 08/03/2012 fsoares $
* @package VirtueMart
* @subpackage Shipping
* @copyright Copyright (C) 2012 Fernando Soares - All rights reserved.
*
* ## Used to parse XML in shipping plugin Correios Brasil
*
*/
