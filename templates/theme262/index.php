...
$showuser7 = ($this->countModules('user7'));
...
<script type="text/javascript" src="<?php echo $path ?>/javascript/jquery.mCustomScrollbar.js"></script>
...
$j(window).load(function() {
			$j("#mcs_container").mCustomScrollbar("horizontal",500,"easeOutCirc",1,"fixed","yes","yes",20); 
			...
			function LoadNewContent(id,file){
				$j("#"+id+" .customScrollBox .content").load(file,function(){
					mCustomScrollbars();
				});
			}
		});		
...
<script type="text/javascript" src="<?php echo $path ?>/javascript/jquery.mousewheel.min.js"></script>
			...
			<div class="space">
				...
				<div class="wrapper">
					<div class="footerText">
						...
						<?php
							if ($menu->getActive() == $menu->getDefault())  { ?>
							 Mais <a rel="nofollow" href="http://www.drupalinformatica.com.br/" target="_blank">Drupal Inform&aacute;tica</a>
							<?php  }
						?>
